...
1. Understand the inner workings of compilers and programming languages.
2. Appreciate the complexity and inner workings of compilers.
3. Design and implement programming languages to solve everyday problems (Domain Specific Languages).
4. Understand effective git management for a long term open source project.
...
---
## Readings:
+ [The Simple Essence of Algebraic Subtyping](https://infoscience.epfl.ch/server/api/core/bitstreams/afe084e0-0050-4542-99c7-c499d2fe1620/content)
+ [Wasm V3 Draft Spec](https://webassembly.github.io/spec/versions/core/WebAssembly-3.0-draft.pdf)
+ [Wasm Component Model Proposal](https://github.com/WebAssembly/component-model)
---
## Assessments
#### Course Assignment
...
Completing a large, multi-phase project is not an easy task and will require effective time management while balancing competing properties and deadlines, while ensuring steady progress towards the final goal.
#### Research Notes
...
---
## Grading:
* Course Assignment: <font color="#c0504d">Weighting Unknown</font>
...
* Research Notes: <font color="#c0504d">Weighting Unknown</font>

---
## Grading Total By Withdrawal Date:
* <font color="#c0504d">Unknown</font>
